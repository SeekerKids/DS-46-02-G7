                ...
                <div class="container">
                    <div>
                        <%
                            ...
                            models.Track track = trackModel.findById(trackId); 
                    ...
                    <div class="track-info">
                       ...
                       <!-- Tombol aksi -->
                        ...
                        <div class="counters mt-3">
                            <p class = "stats">Likes: <%= track.getLikeCount()%></p>
                            <p class = "stats">Shares: <%= track.getShareCount()%></p>
                            <p class = "stats">Streams: <%= track.getStreamCount()%></p>
                        </div>
                    </div>
                    <%} else { %>
